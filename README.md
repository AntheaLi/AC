...
AC is a hardware-aware architecture compiler that turns a compute budget, hardware target, and optional base model into Pareto-front model architectures and architecture deltas. It serves as a quantitative **pre-flight** check.
