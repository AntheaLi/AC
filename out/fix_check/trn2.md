...
**Target**: 1.0B active parameters, 0.2T training tokens, TRAINIUM2 (TP=1 PP=1 DP=1), context=2048.
Serving TBT ≤ 100.0ms, TTFT ≤ Nonems, batch=4.

## Predicted Performance

- **Training throughput**: 25,644 tokens/sec
- **Serving TBT**: 4.3ms (96% under budget)
- **Serving TTFT**: 15.6ms
...
Lattice constraint: must be divisible by TP=1 and tile-aligned for BF16 CTA tiles on TRAINIUM2. d_model=2304 lies on the lattice with n_heads=18 × d_head=128 = 2304.
...
- Candidates generated: 3,726
- Candidates evaluated: 3,726
- Feasible candidates: 3,726
- Pareto frontier size: 246
- Search time: 2.2s
