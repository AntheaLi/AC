...
| Serving TBT (ms) | 5.394 | 5.394 | +0.000 | +0.00% | neutral |
| Prefill / TTFT (ms) | 347.300 | 347.300 | +0.000 | +0.00% | neutral |
| Training TPS (tok/s) | 37890.875 | 37892.058 | +1.183 | +0.00% | improves |
...
|---|---:|---:|---:|---|---|
| HBM bandwidth (decode) | 0.832 | 0.828 | -0.005 | loaded | loaded |
| HBM bandwidth (prefill) | 0.000 | 0.000 | -0.000 | relaxed | relaxed |
| HBM capacity | 0.101 | 0.101 | -0.000 | relaxed | relaxed |
| KV footprint | 0.050 | 0.050 | +0.000 | relaxed | relaxed |
| Tensor-core util (prefill) | 0.671 | 0.671 | +0.000 | relaxed | relaxed |
| Tensor-core util (decode) | 0.029 | 0.029 | +0.000 | relaxed | relaxed |
| All-reduce traffic | 0.017 | 0.017 | +0.000 | relaxed | relaxed |
| Training memory | 0.142 | 0.141 | -0.000 | relaxed | relaxed |
