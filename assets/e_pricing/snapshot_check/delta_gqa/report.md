...
| Serving TBT (ms) | 5.356 | 5.356 | +0.000 | +0.00% | neutral |
| Prefill / TTFT (ms) | 307.532 | 307.532 | +0.000 | +0.00% | neutral |
| Training TPS (tok/s) | 47479.311 | 47480.326 | +1.015 | +0.00% | improves |
...
|---|---:|---:|---:|---|---|
| HBM bandwidth (decode) | 0.839 | 0.835 | -0.005 | loaded | loaded |
...
| Tensor-core util (prefill) | 0.753 | 0.753 | +0.000 | loaded | loaded |
| Tensor-core util (decode) | 0.029 | 0.029 | +0.000 | relaxed | relaxed |
| All-reduce traffic | 0.008 | 0.008 | +0.000 | relaxed | relaxed |
